...
DeepTeam supports multiple frameworks — from dataset-based testing (_BeaverTails, Aegis, HarmActionsBench_) to security and governance standards (_MITRE ATLAS, NIST AI RMF, OWASP Top 10 for LLMs_).
...
- [Aegis](#aegis)
- [HarmActionsBench](#harmactionsbench)
...
The HarmActionsBench framework performs action-level safety evaluation.
...
[Learn more about HarmActionsBench](/docs/frameworks-harmactionsbench)
