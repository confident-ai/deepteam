...
<Tabs items={["Custom", "OpenAI", "Azure", "Ollama", "Gemini", "Anthropic", "Bedrock", "Local", "OrcaRouter", "Portkey"]} groupId="custom-llms">
<Tab value="Custom">
```yaml
models:
  simulator: 
...
models:
  simulator: 
    model:
      ...
      temperature: 1
      api_key: "<your-orcarouter-api-key>" # or set ORCAROUTER_API_KEY
  evaluation:
    ...
```
</Tab>
